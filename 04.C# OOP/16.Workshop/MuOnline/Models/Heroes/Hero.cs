...
namespace MuOnline.Models.Heroes
{
    ...
    public abstract class Hero : IHero, IIdentifiable, IProgress
    {
        ...
        public int Strength
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Strength), value);
        ...
        public int Agility
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Agility), value);
        ...
        public int Stamina
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Stamina), value);
        ...
        public int Energy
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Energy), value);
        ...
        public int Experience
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Experience), value);
        ...
        public int Level
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Level), value);
        ...
        public int Resets
        {
            ...
            private set
            {
                Validator.ValidateLessThanZero(nameof(this.Resets), value);
